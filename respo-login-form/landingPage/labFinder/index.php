...
<div class="wrapper">
	<header>
        ...
        <nav>
          ...
          <div align="left">
                  ...
                  <li id="active"><a href="#">Lab Finder</a></li>
    ...
    <div class="bodyContainer">
    	<section>
        	<div class="wrapper" id="map"><iframe width="719" height="500" frameborder="0" src="//widgets.scribblemaps.com/sm/?d=true&z=true&sc=true&lat=5.938215743341915&lng=80.57569041712725&vz=17&type=road&t=d&width=700&height=400&id=ruhuna uni" style="border:0" allowfullscreen></iframe>
</div>
      </section>         
        <section>
          <h2>Ground Plan</h2>
        	<h2 class="style2">This shows ground plan of the university where each department locations in Science Faculty.</h2>
            <i>
    search for the Pactical Labs.
